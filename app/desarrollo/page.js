...
const LECCIONES = [
  ...
  {n:'L25', cat:'Diseño', t:'Web móvil siempre — toda página e interfaz es responsive desde el inicio', caso:'El sitio y la app deben verse y funcionar en móvil, no solo en escritorio; se añadieron viewport, grillas fluidas, tablas con scroll e imágenes que no desbordan.', regla:'Toda página e interfaz, del sitio y de la app, se construye responsive (web + móvil) desde el inicio y se verifica en móvil antes de darla por terminada.'},
  {n:'L26', cat:'Diseño', t:'Una sola paleta, aplicada a todo — sitio y app', caso:'La app quedó con la paleta editorial (crema + marino + terracota + oro) mientras el sitio seguía oscuro; se migraron todas las páginas a la misma paleta.', regla:'La identidad de color es una sola y se aplica a todas las superficies (sitio y app) a la vez. Un cambio de paleta no está hecho hasta que cubre todo.'},
]
